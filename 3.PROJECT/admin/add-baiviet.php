	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">QL Tài khoản / Thêm bài viết mới</li>
			</ol>
		</div><!--/.row-->
        ...
        <div class="row">
            <div class="col-md-2">
                <form action="add-baiviet-process.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="">title</label>
						<input type="text" name="tieu_de" placeholder="Ex:" >
					</div>
					<div class="form-group">
						...
						<input type="file" name="file" placeholder="Ex: " >
					</div>
					<div style="width:500px;"> 
						<button type="submit" class="btn btn-success" name="submit" style="float:left;">theme</button>
